...
CREATE TABLE Posts (
    ...
    FOREIGN KEY (product_offered) REFERENCES Products(product_id),
    FOREIGN KEY (product_requested) REFERENCES Products(product_id)
);
CREATE TABLE Equivalence (
    ...
    FOREIGN KEY (product1) REFERENCES Products(product_id),
    FOREIGN KEY (product2) REFERENCES Products(product_id)
);
